...
```
[ Prompt hardening       ]  ← make injection harder
[ Input validation       ]  ← catch obvious attacks early
[ Sandboxed execution    ]  ← limit blast radius if injection succeeds
[ Minimal privilege      ]  ← limit what blast radius can actually destroy
[ Output guardrails      ]  ← last-chance filter before damage is done
[ Audit logging          ]  ← know what happened after the fact
```
