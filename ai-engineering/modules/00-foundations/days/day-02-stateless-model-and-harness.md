# Day 2 — The Stateless Model & the Harness-as-OS
...
> **Before you start:** Recall Day 1's load-bearing idea — one sentence, no looking: *what distinguishes AI engineering from training models, and where is the engineer's main surface of leverage?*
